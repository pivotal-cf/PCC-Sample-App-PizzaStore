...
See [GemFire Basics](https://docs.pivotal.io/p-cloud-cache/1-10/index.html#GFBasics) for the briefest of introductions to GemFire,
and see [Region Design](https://docs.pivotal.io/p-cloud-cache/1-10/region-design.html) for a quick tour of GemFire regions.
...
For example, if your PCC service instance is version 1.10,
check out this repository's `release/1.10` branch.
Follow the appropriate setup procedure.

### Prepare with TLS Communication

Note: Make sure to complete the [Prepare for TLS](https://docs.pivotal.io/p-cloud-cache/1-10/prepare-TLS.html) steps from the docs before creating a TLS or non-TLS service instance.
...
under the section [Accessing a Service Instance](https://docs.pivotal.io/p-cloud-cache/1-10/accessing-instance.html) 
